...
<body>
    <form id="form1" runat="server">
        <div class="col-md-4">
            <h2 style="height: 27px; margin-top: 14px">Inserir dados</h2>
        </div>
        <br />
    <asp:label runat="server" text="Nome:" ID="LblNome"></asp:label>
        ...
        <asp:Button ID="btlAdicionarTel" runat="server" OnClick="btlAdicuinarTel_Click" Text="Adicionar" />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    <p>
        ...
        <asp:Button ID="BtnInsere" runat="server" OnClick="BtnCadastrar_Click" Text="Inserir" Height="33px" style="margin-left: 9px" Width="86px" />
    </form>
    </body>
</html>
